...
const Login = () => {
  ...
  return (
    ...
    rounded-full bg-[#333A5C]'>
          ...
          <p onClick={() => navigate('/reset-password')} className='mb-4 text-indigo-500 cursor-pointer'>Forgot
            password?</p>
    ...
    from-indigo-500 to-indigo-900 text-white font-medium'>{state}
        ...
        {state === 'Sign Up' ? (<p className='text-gray-400 text-center text-xs mt-4'>Already have
          an account?{' '}
